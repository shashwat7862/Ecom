...
export class List_user extends Component {
    ...
    render() {
        ...
        const columns = [{
            ...
            Cell: props => (
                <div>
                    <img className="img-responsive" style={{ height: 50 + 'px', width: 50 + 'px' }} src={(props.original.CustomerImage !== "") ? Baseurl + "/" + props.original.CustomerImage : this.state.defaultImage} />
                </div>
            ),
            minWidth: 55
        }, {
