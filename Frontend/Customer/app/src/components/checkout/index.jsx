                                ...
                                <div className="checkout row">
                                            ...
                                            {this.state.showMenu ? (
                                                ...
                                                <div className="menu">
                                                    <div>
                                                        <div>
                                                            {(() => {
                                                                let container = []; this.state.addressList.forEach((val, index) => {
                                                                    container.push(
                                    ...
                                    <div className="col-lg-6 col-sm-12 col-xs-12">
                                        <div className="checkout-details">
                                            ...
                                            <button className="btn-solid btn" onClick={this.placeOrder} style={{ backgroundColor: 'black', color: 'white' }}>Place Order</button>
                                        </div>
                                    </div>
                                </div>
