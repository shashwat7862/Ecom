...
import { productList, searchProducts, deleteProduct } from '../../../Action/ProductAction';
...
export class Digital_pro_list extends Component {
	...
	componentDidMount() {
		this.getProductList(this.state.vendorData._id, true);
	}

	getProductList(vendorId, checked = false) {
		this.props.getProductList(vendorId, checked);
	}
	...
	handleChange(checked) {
		...
		this.getProductList(this.state.vendorData._id, checked);
	}
	...
	deleteProduct(data) {
		...
		// 	});
		this.props.deleteProduct(data.original._id, this.getProductList(this.state.vendorData._id, true))
	}
